...
- Supabase-generated types live in `apps/web/src/types/database.ts` (regenerated by `pnpm db:types`).
- App-level shared types live in `apps/web/src/types/index.ts`. Co-locate component-specific types with the component.
